...
export const MessageSearchComponent = React.forwardRef<MultipleSelectorRef, MultipleSelectorProps>(
    (
        {
            value,
            onChange,
        ...
        const customSearchFilter = (field: string, value: string) => {
            const updatedFilters = [...searchString.filter.filters];
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) => {
                                            handleBadgeInputChanges(option.value, e.target.value);
                                        }}
                                    ...
                                    <button
                                        ...
                                        onClick={() => {
                                            handleUnselect(option);
                                            handleBadgeInputChanges(option.value, '');
                                        }}
                                    >
